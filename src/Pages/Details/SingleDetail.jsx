...
const SingleDetail = ({ detail }) => {
    const { name, title, picture, tags, time, comment, upvote, downvote } = detail;
            ...
            <div className="card mx-[235px] bg-base-100 border-4 border-teal-200 border-y-teal-500 shadow-xl">
                ...
                <div className="card-body text-center">
                    ...
                    <div className="card-actions justify-center">
                        <button className="btn gap-0" onClick={handleLikeClick}><AiFillLike />{likeCount} reactions</button>
                        <button className="btn" onClick={handleDislikeClick}><AiFillDislike />{dislikeCount} Dislikes</button>
                        <button className="btn" onClick={handleCommentClick}><FaRegComment />{commentCount} Comments</button>
                    </div>
                </div>
            </div>
